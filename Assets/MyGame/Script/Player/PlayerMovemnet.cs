...
public class PlayerMovemnet : MonoBehaviour
{
    ...
    private void CameraRotation() // xoay cam
    {
        ...
        // và kiểm tra cam không bị lock.
        {
            ...
            _cinemachineTargetYaw1 += (_input.look.x * deltaTimeMultiplier)*SpeedMouse;   // cập nhật góc xoay theo trục x xoay ngang
            _cinemachineTargetPitch1 += (_input.look.y * deltaTimeMultiplier)*SpeedMouse;// cập nhật góc xoay theo trục y xoay dọc
        }
